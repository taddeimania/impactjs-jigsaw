...
MyGame = ig.Game.extend({
    ...
    init: function() {
        ...
        ig.game.spawnEntity('EntityPiece2', 241, 543, {name: "thomas2"});
        ...
        ig.game.spawnEntity('EntityPiece6', 60, 90, {name: "thomas6"});
        ig.game.spawnEntity('EntityPiece7', 700, 98, {name: "thomas7"});
        ig.game.spawnEntity('EntityPiece8', 96, 149, {name: "thomas8"});
    },
    draw: function() {
        this.parent();
